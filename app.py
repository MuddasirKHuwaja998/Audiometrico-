...
def generate_pdf(image_path, paziente_info):
    ...
    # Title
    title_style = ParagraphStyle(name='Title', fontName='Times-Roman', fontSize=16, leading=20, spaceAfter=0, alignment=1)
    ...
    info_table = Table(info_table_data, colWidths=[130, 370], hAlign='CENTER')
    ...
    legend_text = """
    Legenda:<br/>
    SX Aria (X blu): Orecchio sinistro via aerea<br/>
    DX Aria (O rosso): Orecchio destro via aerea<br/>
    SX Ossea (> blu): Orecchio sinistro via ossea<br/>
    DX Ossea (< rosso): Orecchio destro via ossea<br/>
    SX Masc. ([] blu): Orecchio sinistro mascherato via aerea<br/>
    DX Masc. (Δ rosso): Orecchio destro mascherato via aerea<br/>
    Non rilev. (v nero): Soglia non rilevabile
    """
    ...
    # Report note
    report_note = """
    REFERTO: Rilevata una lieve ipoacusia si consiglia di approfondire lo stato del proprio udito con una visita in telemedicina
    """
